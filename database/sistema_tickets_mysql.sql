...
CREATE TABLE `orden` (
  ...
  metodo_pago ENUM('tarjeta', 'efectivo', 'visalink', 'compraclic', 'cortesia', 'transferencia', 'mixto') NOT NULL DEFAULT 'tarjeta',
  ...
  comprador_email VARCHAR(150) NULL,
...
CREATE TABLE transaccion (
  ...
  moneda CHAR(3) NOT NULL DEFAULT 'GTQ',
  metodo_pago ENUM('tarjeta', 'efectivo', 'visalink', 'compraclic', 'cortesia', 'transferencia') NOT NULL,
  estado ENUM('pendiente', 'autorizada', 'pagada', 'rechazada', 'cancelada', 'reembolsada') NOT NULL DEFAULT 'pendiente',
  numero_autorizacion VARCHAR(120) NULL,
...
CREATE TABLE entrada (
  ...
  tipo_pago ENUM('tarjeta', 'efectivo', 'visalink', 'compraclic', 'cortesia', 'transferencia') NOT NULL,
